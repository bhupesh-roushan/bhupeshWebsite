...
//       .then((result) => {
//         toast("Message Sent!");
//         setFormData({ name: "", email: "", message: "", mobile: "" ,countryCode: "+91"});
//       })
//       .catch((err) => toast("Oops! Something went wrong. Please try again."));
//   };
...
//             {/* <div className="relative">
//               <div className="flex">
//                 <span className="flex items-center px-4 bg-white/10 border border-white/10 border-r-0 rounded-l text-white">
//                   +91
//                 </span>
//                 <input
//                   type="tel"
...
//                   maxLength={10}
//                   pattern="[0-9]{10}"
//                   className="w-full bg-white/10 border border-white/10 rounded-r px-4 py-3 text-white transition focus:outline-none focus:border-blue-500 focus:bg-blue-500/5"
...
//         setFormData({
//           ...formData,
//           mobile:`${countryCode} ${e.target.value.replace(/\D/g, "")}`,
//         })
//       }
//       placeholder="Your Mobile Number"
//       className="w-full bg-white/10 border border-white/10 rounded-r px-4 py-3 text-white transition focus:outline-none focus:border-blue-500 focus:bg-blue-500/5"
